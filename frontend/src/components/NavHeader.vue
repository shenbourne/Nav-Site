<template>
  <header class="nav-header">
    <div class="header-title">
      ...
      <span>{{ navStore.siteSettings.title || 'My Nav 的主页' }}</span>
    </div>
    <div class="header-actions">
      ...
      <div class="toggle-group">
        <button
          class="toggle-btn"
          :class="{ active: uiStore.layoutMode === 'paginated' }"
          @click="uiStore.setLayoutMode('paginated')"
          title="分页模式"
        >
        ...
        <button
          class="toggle-btn"
          :class="{ active: uiStore.layoutMode === 'stream' }"
          @click="uiStore.setLayoutMode('stream')"
          title="一栏模式"
        >
      ...
      <button class="admin-btn" @click="$emit('openAdmin')">
